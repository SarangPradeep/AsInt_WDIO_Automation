...
describe('BTP - Functional Location Application - Adapt Filter Functional test', () => {
    ...
    it('should add and verify all the adapt filters', async function () {
        ...
        const filterChecks: { name: string; run: () => Promise<void> }[] = [
            ...
            { name: 'functionalLocationAdaptFilter', run: () => adaptFilterHelper.functionalLocationAdaptFilterFL('ASPM-REFI-P001-CDPU') },
            { name: 'functionalLocationDescriptionFilter', run: () => adaptFilterHelper.functionalLocationDescriptionFilterFL('Crude Distillation & Processing Unit') },
            ...
            { name: 'parentFunctionalLocationAdaptFilter', run: () => adaptFilterHelper.parentFunctionalLocationAdaptFilter('ASPM-REFI-P001') },
            { name: 'parentFunctionalLocationDescriptionAdaptFilter', run: () => adaptFilterHelper.parentFunctionalLocationDescriptionAdaptFilter('ASPM Refinery Facilities Plant 1') },
