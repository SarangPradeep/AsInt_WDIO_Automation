    ...
    class RCADetailPage {
        ...
        private get whyNode1() { return $("((//div[text()='Why']/ancestor::div[2])[1])"); }
        private get whyNode2() { return $("(//div[text()='Why']/ancestor::div[2])[2]"); }
        ...
        private get advanceSearchSwitch() { return $("//bdi[text()='Advance Search']/ancestor::div[contains(@class,'sapMHBox')]//div[@role='switch']"); }
        private get firstEquipmentRow() { return $("(//tr[contains(@class,'sapMListTblRow')])[2]"); }
        private get saveButton4() { return $("//div[@role='dialog']//button[.//bdi[text()='Save']]"); }
        private get okButton3() { return $("//button[.//bdi[text()='OK']]"); }
        ...
        private get advanceSearchSwitch2() { return $("//bdi[text()='Advance Search']/ancestor::div[contains(@class,'sapMHBox')]//div[@role='switch']"); }  
        private get firstEquipmentRow2()  { return $("(//tr[@aria-rowindex='2']//div[@role='checkbox'])[1]"); }
        private get confirmButton2() { return $("//button[.//bdi[normalize-space()='Confirm']]"); }
        ...
        private get selectedCheckbox2() {  return $("//tr[.//text()='This is the first why']//div[@role='checkbox']"); }
        ...
        private get maintAndServ() { return $("//bdi[text()='Maintenance and Service']"); }
        private get notificationSection() { return $("//h3//span[normalize-space()='Notification']"); }
        private get maintenanceOrderSection() { return $("//span[normalize-space()='Maintenance Order']/ancestor::*[@role='heading']"); }
        private get maintenancePlansSection() { return $("//span[normalize-space()='Maintenance Plans']/ancestor::*[@role='heading']"); }
        private get noDataText() { return $("//td[normalize-space()='No Data']"); }
        ...
        async verifyEventInWhyWhyAnalysis() {
            ...
            await utils.waitForBusyIndicatorToDisappear();
            await utils.clickWithWait(this.advanceSearchSwitch);
            await utils.waitForBusyIndicatorToDisappear();
            ...
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Save button clicked successfully");
            await utils.clickWithWait(this.okButton3);
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Save button clicked successfully");   
            ...
            await utils.clickWithWait(this.addChildButton);
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Added 2nd Child successfully");       

            await utils.clickWithWait(this.addWhyButton1);
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Add Why button clicked successfully"); 

            await utils.setValueWithWait(this.analysisTextArea, rcaData.secondWhy);
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Why analysis text entered successfully");
            ...
            await utils.clickWithWait(this.whyNode2);
            await utils.waitForBusyIndicatorToDisappear();
            console.log("Why node clicked successfully");
            ...
            await utils.waitForBusyIndicatorToDisappear();
            await utils.clickWithWait(this.advanceSearchSwitch2);
            await utils.waitForBusyIndicatorToDisappear();
            ...
            await utils.clickWithWait(this.confirmButton2);
            await utils.waitForBusyIndicatorToDisappear();
        ...
        async verifyMaintenanceAndServiceSections(): Promise<boolean> {

            await browser.pause(4000);
            await utils.clickWithWait(this.maintAndServ);
            await utils.waitForBusyIndicatorToDisappear();
            await this.notificationSection.waitForDisplayed({ timeout: 15000 });
            const notificationVisible = await this.notificationSection.isDisplayed();
        
            await this.maintenanceOrderSection.waitForDisplayed({ timeout: 15000 });
            const maintenanceOrderVisible = await this.maintenanceOrderSection.isDisplayed();
        
            await this.maintenancePlansSection.waitForDisplayed({ timeout: 15000 });
            const maintenancePlansVisible = await this.maintenancePlansSection.isDisplayed();
        
            await this.noDataText.waitForDisplayed({ timeout: 15000 });
            const noDataVisible = await this.noDataText.isDisplayed();
            return notificationVisible && maintenanceOrderVisible && maintenancePlansVisible && noDataVisible;
...
export default new RCADetailPage();