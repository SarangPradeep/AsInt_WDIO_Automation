...
describe('BTP - RCM Analysis Application - Create Baseline via technical object', () => {
    ...
    it('should create baseline assessment by choosing technical object and creating a new System', async () => {
